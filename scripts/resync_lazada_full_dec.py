#!/usr/bin/env python3
"""
Re-sync Lazada Orders for Full December 2025 (12.12 Backlog Recovery).
Target: Dec 1 - Dec 31, 2025.
"""
import sys
import os
import asyncio
...
async def resync_lazada_full_dec():
    print("=== Starting Lazada Re-sync for FULL December 2025 ===")
...
if __name__ == "__main__":
    asyncio.run(resync_lazada_full_dec())
