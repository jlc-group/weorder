...
async def run():
    ...
    print("=" * 60)
    print("Applying DELIVERY_FAILED status (not_received orders)")
    print("=" * 60)
    ...
    async with httpx.AsyncClient(timeout=30.0) as c:
        ...
        while True:
            ...
            for ret in returns:
                ...
                # Check for not_received
                if "not_received" in return_reason:
                    stats["found"] += 1
                    
                    # Force update to DELIVERY_FAILED
                    cur.execute(
    ...
    print(f"\n=== COMPLETE ===")
    print(f"Not_received found in API: {stats['found']}")
